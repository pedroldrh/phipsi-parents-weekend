...
const STOPS: Stop[] = [
  ...
  },
  {
    ...
    when: "Daytime",
    title: "The Darty",
    place: "The Haus → Pumptown",
    placeNote: "starts at the house, then moves down the street",
    desc: "A party in the daylight: it kicks off on the lawn at the house — cornhole boards out, music on, drinks in the cooler — then the whole crowd walks over to Pumptown to keep it going. Outdoors, low-key, and easy to enjoy — parents are very welcome on the boards. Still pencilled in, hence the question mark.",
    tbd: true,
